...
const ALERTMANAGER_FILTERS: &[CatalogField] = &[
    CatalogField {
        name: "severity",
        label: "Severity",
        description: "Only match this severity",
    ...
    CatalogField {
        name: "alertname",
        label: "Alert name",
        description: "Only match this specific alert name",
        input_type: "text",
        required: false,
        default_value: None,
        options: NO_OPTIONS,
...
const ALERTMANAGER_ACTIONS: &[CatalogCapability] = &[
    CatalogCapability {
        kind: "alert_firing",
        label: "Alert is firing",
        description: "An alert generated by Prometheus Alertmanager is firing",
        connection_service: Some("alertmanager"),
        fields: ALERTMANAGER_FILTERS,
    },
];
...
const ALERTMANAGER_CONNECTION_FIELDS: &[CatalogField] = &[CatalogField {
    ...
    description: "Required. The exact expected Authorization header value (e.g. Basic ... or Bearer ...)",
    input_type: "password",
    required: true,
    default_value: None,
    options: NO_OPTIONS,
...
pub const AUTOMATION_CATALOG: &[AutomationServiceDefinition] = &[
    ...
    AutomationServiceDefinition {
        ...
        reactions: &[],
        connection: Some(CatalogConnection {
            description: "Receive webhooks from Alertmanager authenticated via Authorization header",
