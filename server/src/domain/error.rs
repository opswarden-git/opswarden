...
pub enum DomainError {
    ...
    UserAlreadyExists,
    InvalidCredentials,
    /// Too many sign-in attempts against one account.
    TooManyAttempts,
    InvalidToken,
    InvalidTeamName,
    /// A Team image exceeded 1 MiB, used an unsupported type, or had a mismatched signature.
    InvalidTeamImage,
    TeamImageNotFound,
...
impl DomainError {
    ...
    pub fn code(&self) -> &'static str {
        match self {
            ...
            DomainError::TooManyAttempts => "too_many_attempts",
            DomainError::InvalidToken => "invalid_token",
            DomainError::InvalidTeamName => "invalid_team_name",
            DomainError::InvalidTeamImage => "invalid_team_image",
            DomainError::TeamImageNotFound => "team_image_not_found",
...
impl std::fmt::Display for DomainError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            DomainError::TooManyAttempts => write!(f, "Too many sign-in attempts for this account"),
            DomainError::InvalidToken => write!(f, "Invalid or expired token"),
            DomainError::InvalidTeamName => write!(f, "Team name cannot be empty"),
            DomainError::InvalidTeamImage => write!(f, "Team image is invalid"),
            DomainError::TeamImageNotFound => write!(f, "Team image was not found"),
