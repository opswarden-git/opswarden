// --- server/src/app/incident/tests.rs ---
//
// Shared in-memory doubles for the incident use cases. They live in their own
// file rather than inside `mod.rs` so the module root stays a list of what the
// module offers; the path `crate::app::incident::tests::*` is unchanged.
